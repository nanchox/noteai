    ...
    <main className="min-h-screen bg-surface flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <div className="space-y-3 mb-10">
          {[
            ["📝", "Notas con imágenes y texto libre"],
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 font-semibold py-3.5 px-6 rounded-xl hover:bg-gray-100 active:scale-95 transition-all disabled:opacity-50"
        >
          {loading ? (
        ...
        <p className="text-xs text-gray-500 text-center mt-6">
          Al continuar aceptas guardar tus notas de forma segura en la nube.
        </p>
      </div>
    </main>
  );
